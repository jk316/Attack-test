...
class TestPingRttTool:
    ...
    def test_allowlist_check_rejects_non_allowlist_ip(self):
        ...
        from src.tools.ping_rtt_tool import ping_rtt_tool, ALLOWLIST, validate_target
    ...
    def test_allowlist_check_accepts_allowlist_ip(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = ping_rtt_tool("192.168.1.1", count=2)
    ...
    def test_output_json_structure(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = ping_rtt_tool("192.168.1.1", count=1)
    ...
    def test_count_parameter_passed_to_ping(self):
        ...
        mock_output = "PING 192.168.1.1: 56 data bytes\n--- 192.168.1.1 ping statistics ---\n1 packets transmitted, 1 packets received, 0% packet loss\nround-trip min/avg/max = 1.0/1.0/1.0 ms"

        with patch('subprocess.run') as mock_run:
            mock_run.return_value = MagicMock(returncode=0, stdout=mock_output, stderr="")
            ping_rtt_tool("192.168.1.1", count=5)
