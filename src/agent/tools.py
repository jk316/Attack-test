...
def traffic_send(
    ...
    """Send controlled UDP traffic to a target. REQUIRES HUMAN APPROVAL.
    ...
    Args:
        ...
        dst_port: Target UDP port (1-65535).
...
def pcap_profile(pcap_path: str, count: int = DEFAULT_COUNT_LIMIT) -> dict[str, Any]:
    ...
    Only UDP packets are profiled; TCP/ICMP are noted but ignored.
...
EXPERIMENT_TOOLS = [pcap_profile, traffic_send, ping_rtt, log_result]
